...
namespace CSharp.Utils
{
    public static class GenericBaseConverter
    {
        ...
        public static string ConvertToString(BigInteger value, int genericBase)
        {
            const int pad = 0;
            string digits = Digits.Substring(0, genericBase);
        ...
        public static BigInteger ConvertFromString(string s, int genericBase)
        {
            string digits = Digits.Substring(0, genericBase);
            BigInteger result;
        ...
        public static bool TryConvertFromString(string s, string digits, out BigInteger result) 
            => Parse(s, digits, out result) == ParseCode.Success;
